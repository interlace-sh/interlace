...
-- @fields: {"w_warehouse_name": "str", "w_warehouse_sq_ft": "int", "w_city": "str", "w_county": "str", "w_state": "str", "w_country": "str", "ship_carriers": "str", "year_": "int", "jan_sales": "float", "feb_sales": "float", "mar_sales": "float", "apr_sales": "float", "may_sales": "float", "jun_sales": "float", "jul_sales": "float", "aug_sales": "float", "sep_sales": "float", "oct_sales": "float", "nov_sales": "float", "dec_sales": "float", "jan_sales_per_sq_foot": "float", "feb_sales_per_sq_foot": "float", "mar_sales_per_sq_foot": "float", "apr_sales_per_sq_foot": "float", "may_sales_per_sq_foot": "float", "jun_sales_per_sq_foot": "float", "jul_sales_per_sq_foot": "float", "aug_sales_per_sq_foot": "float", "sep_sales_per_sq_foot": "float", "oct_sales_per_sq_foot": "float", "nov_sales_per_sq_foot": "float", "dec_sales_per_sq_foot": "float", "jan_net": "float", "feb_net": "float", "mar_net": "float", "apr_net": "float", "may_net": "float", "jun_net": "float", "jul_net": "float", "aug_net": "float", "sep_net": "float", "oct_net": "float", "nov_net": "float", "dec_net": "float"}
