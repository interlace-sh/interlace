"""
Core event bus for broadcasting execution state changes.

Provides pub/sub mechanism for decoupling the execution engine from consumers
like the Display, StateStore, and REST API (SSE). Any component can subscribe
to flow/task lifecycle events without the Executor knowing about it.
...
logger = get_logger("interlace.core.events")


class EventBus:
    """
    Event bus for broadcasting real-time execution updates.
