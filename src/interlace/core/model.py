...
def model(
    ...
    checks: list[dict[str, Any]] | list[Any] | None = None,
    **kwargs: Any,
    ...
    Args:
        ...
        checks: Optional list of check configurations or Check instances to run
                after materialisation. Each dict must include ``type`` (e.g.
                "not_null", "unique") and check-specific fields.
                Example: checks=[{"type": "not_null", "column": "id"}]
